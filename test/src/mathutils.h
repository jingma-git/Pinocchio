...
template <class T>
T QUAD(const T &x) { return SQR(SQR(x)); }

template <class T>
class maximum : public binary_function<T, T, T>
{
public:
...
template <class T>
class minimum : public binary_function<T, T, T>
{
public:
...
class myMult : public binary_function<A1, A2, R>
{
public:
...
template <class A1, class A2, class R>
class myDiv : public binary_function<A1, A2, R>
{
public:
    R operator()(const A1 &a1, const A2 &a2) const { return a1 / a2; }
};
...
template <class T>
class ident : public unary_function<T, T>
{
public:
...
public:
    ...
    template <class From>
    T operator()(const From &x) const { return T(x); }
};
